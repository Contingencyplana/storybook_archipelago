##
# Path: a0_0_sailing_mode/a1_1_shell_bazaar_minigame/a0_1_pearl_action_node/integration.py
# ----------------------------------------------------------------------
# Integration Layer — Pearl Action Node
#
# Role:
# - Entry point for the Pearl Action node in Shell Bazaar minigame.
