##
# Path: a0_0_sailing_mode/a1_1_shell_bazaar_minigame/a0_2_coral_counter_node/integration.py
# ----------------------------------------------------------------------
# Integration Layer — Coral Counter Node
#
# Role:
# - Entry point for the Coral Counter node in Shell Bazaar minigame.
