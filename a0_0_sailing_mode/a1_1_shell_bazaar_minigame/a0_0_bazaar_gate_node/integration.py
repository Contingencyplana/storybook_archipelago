# Path: a0_0_sailing_mode/a1_1_shell_bazaar_minigame/a0_0_bazaar_gate_node/integration.py
# ----------------------------------------------------------------------
# Integration Layer — Bazaar Gate Node
#
# Role:
# - Entry point for the Shell Bazaar minigame stanza.
